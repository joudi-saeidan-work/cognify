...
export const CardItem = ({ data, index }: CardItemProps) => {
  ...
  if (isEditing) {
    return (
      <>
        <div className="relative flex flex-col justify-between border-2 border-transparent hover:border-black/30 py-2 px-3 text-sm bg-white rounded-md shadow-none w-full">
    ...
    <Draggable draggableId={data.id} index={index}>
      {(provided) => (
        <div
          ...
          className="relative flex flex-col justify-between border-2 border-transparent hover:border-black/30 py-2 px-3 text-sm bg-white rounded-md shadow-sm w-full"
        >
          <span
